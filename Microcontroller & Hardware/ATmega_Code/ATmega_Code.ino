...
//TEMP//
//NOTE: The temp doesn't work on tinkercad as it doesn't have NTC sensors.
// The code below is for NTC Sensor (replace 500 with "analogRead(TempPin)" for using with real NTC sensor)
